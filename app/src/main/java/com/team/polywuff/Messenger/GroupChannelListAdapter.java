...
public class GroupChannelListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void load(){
        try{
            ...
            File dataFile = new File(appDir, TextUtils.generateMD5(SendBird.getCurrentUser().getUserId() + "channel_list") + ".date");
            ...
            if (lastMessage != null) {
                ...
                if (lastMessage instanceof UserMessage) {
                    ...
                    String lastMessageString = String.format(
                            ...
                            ((FileMessage) lastMessage).getSender().getUserId());
